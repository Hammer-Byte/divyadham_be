...
@section('content')
    ...
    <div class="card">
        <div class="d-flex justify-content-between">
            ...
            <div class="m-3">
                <a href="{{route('manage.postCreate')}}" title="Add"><i class="text-primary bx bx-plus bx-md"></i></a>
            </div>
        </div>
        <div class="row m-2">
    ...
    $(document).ready(function() {
        $('#postsTable').DataTable({
            ...
            "columns": [
                ...
                { "data": "type", "className": "", "searchable": true, "orderable": true},
                { "data": "created_at", "className": "", "searchable": true, "orderable": true},
                ...
                { "data": null, "className": "text-center", "orderable": false, "searchable": false,
                    "render": function (data, type, row) {
                                var tableName = "{{$table_name}}"
                                var editUrl = "{{ route('manage.postEdit', ':id') }}".replace(':id', row.id);
                                return `
