...
Route::middleware(["web"])->group(function () {
    ...
    Route::middleware(["AdminUserCheck"])->group(function () {
        ...
        Route::post("/delete", [CommonController::class, "delete"])->name(
            "delete"
        );
        ...
        //Admins
        Route::get("admins", [AdminsController::class, "index"])->name(
            "admins"
        );
        ...
        //Events
        Route::get("events", [EventsController::class, "index"])->name(
            "events"
        );
        ...
        Route::post("post/add", [PostsController::class, "save"])->name(
            "postAdd"
        );
        ...
        Route::post("page/add", [PagesController::class, "save"])->name(
            "pageAdd"
        );
